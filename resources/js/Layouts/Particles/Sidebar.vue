  ...
  <div class="h-19.5">
    ...
    <div class="items-center p-3">
        <Link :href="route('dashboard')">
            <div class="pl-4 flex items-center w-full">
                <a class="toggle text-[#42275a] no-underline hover:no-underline font-bold text-l tracking-wide" href="#">
                    <img class="w-8 h-8 bg-[#734b6d] rounded-md fill-current inline mb-1" src="/images/chart.svg" />
                    TOTAL CALIBER
                </a>
            </div>
        </Link>
