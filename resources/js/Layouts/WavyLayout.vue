...
<template>
    <div :class="position" class="z-0 transition-all fixed bottom-8 mx-8 flex p-4 bg-green-300 bg-opacity-80 rounded-lg lg:max-w-[400px] mx-auto py-6 px-4 sm:px-6 lg:px-8 lg:mt-4" role="alert">
