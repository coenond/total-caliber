...
<template>
      ...
      <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
        ...
        <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden mt-2 lg:mt-0 bg-white lg:bg-transparent text-gray-100 p-4 lg:p-0 z-20" id="nav-content">
          <ul class="list-reset lg:flex justify-end flex-1 items-center">
            ...
            <li class="mr-3">
              <a class="inline-block text-gray-200 no-underline hover:text-gray-800 hover:text-underline py-2 px-4" href="#">Strava Data</a>
            </li>
            <li class="mr-3">
    ...
    <div class="pt-24">
      <div class="container px-3 mx-auto flex md:flex-row justify-center tracking-wide">
        ...
        <div class="md:w-2/5 py-6 text-center align-right">
          ...
          <img class="z-50" src="images/hero_01_running.svg" />
        </div>
      </div>
    </div>
      ...
      <div class="container max-w-5xl mx-auto m-8">
        ...
        <div class="flex flex-wrap">
          ...
          <div class="w-full sm:w-1/2 p-6">  
            <img class="w-5/6 sm:h-128 mx-auto" src="images/image_1.svg" />
          </div>
        </div>
    ...
    <section v-if="false" class="bg-white border-b py-8">
    ...
    <section v-if="false" class="bg-gray-100 py-8">
